    ...
    const verifyData = async () => {
      ...
      try {
        ...
        const checked = rows.map((r) => {
          ...
          [
            { canonicalKey: "Manufacturer", pick: manufacturerPick, expected: best.manufacturer, comparator:
  FIELD_COMPARATORS.manufacturer },
            ...
            { canonicalKey: "Caliber", pick: caliberPick, expected: best.caliber, comparator:
  FIELD_COMPARATORS.caliber },
            { canonicalKey: "Importer", pick: importerPick, expected: best.importer, comparator:
  FIELD_COMPARATORS.importer },
            { canonicalKey: "Country", pick: countryPick, expected: best.country, comparator:
  FIELD_COMPARATORS.country },
      ...
      <main style={{ fontFamily: "sans-serif", padding: "40px" }}>
        ...
        {results.length > 0 && (
          <div style={{ marginTop: 20 }}>
            ...
            >
              <span style={{ padding: "6px 10px", background: "#e8f5e9", border: "1px solid #c8e6c9", borderRadius:
  6 }}>
                VERIFIED: <strong>{stats.verified}</strong> ({stats.pv}%)
              </span>
              <span style={{ padding: "6px 10px", background: "#fff8e1", border: "1px solid #ffe082", borderRadius:
  6 }}>
                NOT VERIFIED: <strong>{stats.notVerified}</strong> ({stats.pnv}%)
              </span>
              <span style={{ padding: "6px 10px", background: "#eeeeee", border: "1px solid #cccccc", borderRadius:
  6 }}>
